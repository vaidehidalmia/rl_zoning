# =============================================================================
# MAIN CONFIGURATION - UPDATED FOR TRANSFER LEARNING
# =============================================================================
...
if COMPLEXITY < 30:
    NET_ARCH = [128, 128]  # UPDATED: Consistent architecture for transfer
    ENT_COEF = 0.05  # UPDATED: Fixed entropy coefficient
elif COMPLEXITY < 80:
    NET_ARCH = [256, 256]  # UPDATED: Consistent architecture for transfer
    ENT_COEF = 0.05
else:
    NET_ARCH = [512, 256]
    ENT_COEF = 0.02

# UPDATED: Curriculum settings for transfer learning
CURRICULUM_GRID_SIZES = [4, 5, 6]
CURRICULUM_MAX_OBJECTS = {4: 3, 5: 3, 6: 2}
