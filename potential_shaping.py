class PotentialShaping:
    ...
    def get_potential(self, agent_pos, carried_object, objects, grid_size):
        ...
        if carried_object != -1:
            ...
            min_distance = min(self.manhattan_distance(agent_pos, obj_pos) 
    ...
    def get_shaping_reward(self, agent_pos, carried_object, objects, grid_size):
        ...
        """
        current_potential = self.get_potential(agent_pos, carried_object, objects, grid_size)
    ...
    def reset(self, agent_pos, carried_object, objects, grid_size):
        ...
        self.previous_potential = self.get_potential(agent_pos, carried_object, objects, grid_size)
